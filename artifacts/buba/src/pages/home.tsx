  ...
  return (
    <div className="min-h-screen bg-background text-foreground overflow-x-hidden font-sans">
        ...
        <div className="relative z-20 container mx-auto px-4 flex flex-col items-center text-center">
          ...
          <motion.div initial="hidden" animate="visible" variants={stagger} className="flex flex-col items-center">
            ...
            <motion.div variants={fadeInUp} className="flex flex-wrap items-center justify-center gap-4 md:gap-6">
              ...
              <a href="https://telegram.org" target="_blank" rel="noreferrer" className="w-12 h-12 md:w-14 md:h-14 rounded-full border border-white/20 flex items-center justify-center bg-white/5 hover:bg-white/10 transition-colors box-glow-blue hover:border-secondary text-secondary">
        ...
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <motion.div variants={fadeInUp} className="flex flex-col gap-4 md:gap-6">
              <h2 className="text-2xl sm:text-3xl md:text-4xl font-display font-bold text-glow-blue text-secondary leading-tight">Chaotic Energy. Pure Magic.</h2>
      ...
      <section id="tokenomics" className="py-16 md:py-32 relative bg-black/40 border-y border-white/5">
        ...
        <div className="container mx-auto px-4 relative z-10">
          <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={fadeInUp} className="text-center mb-10 md:mb-20">
            <h2 className="text-2xl md:text-4xl font-display font-bold text-glow-gold text-primary mb-4">The Sacred Numbers</h2>
          ...
          <div className="grid md:grid-cols-2 gap-4 md:gap-8">
            <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={fadeInUp} className="p-6 md:p-10 rounded-2xl border border-secondary/30 bg-card/50 backdrop-blur-md box-glow-blue text-center group hover:-translate-y-2 transition-transform duration-300">
              ...
              <div className="font-black font-display text-secondary text-glow-blue leading-none" style={{ fontSize: "clamp(1.75rem, 7vw, 3.5rem)" }}>0 / 0</div>
            ...
            <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={fadeInUp} className="p-6 md:p-10 rounded-2xl border border-accent/30 bg-card/50 backdrop-blur-md shadow-[0_0_20px_hsl(120,100%,50%,0.2)] text-center group hover:-translate-y-2 transition-transform duration-300">
              ...
              <div className="font-black font-display text-accent leading-none" style={{ fontSize: "clamp(1.75rem, 7vw, 3.5rem)", textShadow: '0 0 30px hsl(120 100% 50% / 0.6)' }}>BURNED</div>
      ...
      <section id="roadmap" className="py-16 md:py-32 relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 relative z-10">
          <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={fadeInUp} className="text-center mb-10 md:mb-20">
            <h2 className="text-2xl md:text-4xl font-display font-bold text-glow-gold text-primary mb-4">The Quest Ahead</h2>
              ...
              {[
                ...
                >
                  <div className="flex items-center gap-2 md:gap-4 mb-3 flex-wrap">
                    ...
                    <h3 className={`text-base md:text-xl font-display font-bold text-${phase.color}`}>{phase.title}</h3>
                  </div>
      ...
      <footer className="py-10 md:py-12 border-t border-white/10 relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 text-center relative z-10">
          ...
          <div className="flex justify-center gap-6 mb-6">
            <a href="https://twitter.com" className="text-muted-foreground hover:text-secondary transition-colors"><FaTwitter size={28} /></a>
            <a href="https://telegram.org" className="text-muted-foreground hover:text-secondary transition-colors"><FaTelegramPlane size={28} /></a>
          </div>
