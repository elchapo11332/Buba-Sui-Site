...
const jumpVariant = (delay: number) => ({
  animate: {
    y: [0, -22, 4, -10, 1, 0],
    transition: {
      duration: 0.65,
...
function JumpingText({
  ...
  return (
    <Tag className={`inline-flex flex-wrap items-end gap-x-0 ${className ?? ""}`}>
      {chars.map((ch, i) =>
        ch === " " ? (
          ...
          <motion.span
            ...
            animate="animate"
            variants={jumpVariant(baseDelay + i * 0.06)}
          >
            {ch}
          </motion.span>
        )
          ...
          <motion.div initial="hidden" animate="visible" variants={stagger} className="flex flex-col items-center">
            <motion.div variants={fadeInUp}>
              <JumpingText
                ...
                as="h1"
                baseDelay={0}
                className="text-4xl sm:text-5xl md:text-7xl font-black font-display tracking-wide text-glow-gold mb-3 md:mb-4 text-primary leading-none"
              />
            </motion.div>
            <motion.div variants={fadeInUp}>
              <JumpingText
                text="The Chaotic Good Wizard of the SUI Blockchain."
                baseDelay={0.3}
                className="text-base md:text-xl text-muted-foreground max-w-xl mx-auto font-medium mb-2 leading-relaxed px-2"
              />
              <JumpingText
                text="Cast spells. Stack bags. Embrace the weird."
                baseDelay={0.6}
                className="text-base md:text-xl text-muted-foreground max-w-xl mx-auto font-medium mb-8 md:mb-10 leading-relaxed px-2"
              />
            </motion.div>
        ...
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <motion.div variants={fadeInUp} className="flex flex-col gap-4 md:gap-6">
              <JumpingText
                text="Chaotic Energy. Pure Magic."
                as="h2"
                baseDelay={0}
                className="text-2xl sm:text-3xl md:text-4xl font-display font-bold text-glow-blue text-secondary leading-tight"
              />
      ...
      <section id="tokenomics" className="py-16 md:py-32 relative bg-black/40 border-y border-white/5">
        ...
        <div className="container mx-auto px-4 relative z-10">
          <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={fadeInUp} className="text-center mb-10 md:mb-20">
            <JumpingText
              text="The Sacred Numbers"
              as="h2"
              baseDelay={0}
              className="text-2xl md:text-4xl font-display font-bold text-glow-gold text-primary mb-4"
            />
          ...
          <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={fadeInUp} className="mb-6 md:mb-16 p-6 md:p-10 rounded-3xl border border-primary/40 bg-card/40 backdrop-blur-md box-glow-gold text-center">
            ...
            <JumpingText
              text="1B"
              baseDelay={0}
              className="font-black font-display text-primary text-glow-gold leading-none"
              as="div"
            />
          ...
          <div className="grid md:grid-cols-2 gap-4 md:gap-8">
            <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={fadeInUp} className="p-6 md:p-10 rounded-2xl border border-secondary/30 bg-card/50 backdrop-blur-md box-glow-blue text-center group hover:-translate-y-2 transition-transform duration-300">
              ...
              <JumpingText
                text="0 / 0"
                baseDelay={0}
                className="font-black font-display text-secondary text-glow-blue leading-none text-4xl md:text-6xl"
              />
            ...
            <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={fadeInUp} className="p-6 md:p-10 rounded-2xl border border-accent/30 bg-card/50 backdrop-blur-md shadow-[0_0_20px_hsl(120,100%,50%,0.2)] text-center group hover:-translate-y-2 transition-transform duration-300">
              ...
              <JumpingText
                text="BURNED"
                baseDelay={0}
                className="font-black font-display text-accent leading-none text-4xl md:text-6xl"
              />
              ...
              {[
                ...
                >
                  <div className="flex items-center gap-2 md:gap-4 mb-3 flex-wrap">
                    <span className={`text-xs font-bold uppercase tracking-widest px-2 py-1 rounded-full border ${phase.border} text-${phase.color}`}>
                      {phase.phase}
                    </span>
                    {phase.done && (
                      <span className="text-xs font-bold uppercase tracking-widest px-2 py-1 rounded-full bg-primary/20 text-primary border border-primary/30">
                        LIVE
                      </span>
                    )}
                    <JumpingText
                      ...
                      as="h3"
                      baseDelay={0}
                      className={`text-base md:text-xl font-display font-bold text-${phase.color}`}
                    />
                  </div>
      ...
      <footer className="py-10 md:py-12 border-t border-white/10 relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 text-center relative z-10">
          <JumpingText
            ...
            as="h2"
            baseDelay={0}
            className="text-xl md:text-2xl font-display font-bold text-primary mb-6 text-glow-gold"
          />
